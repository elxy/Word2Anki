...
def padandsplit(message):
    ...
    return [[struct.unpack("<L", message[i + j:i + j + 4])[0] for j in range(0, 64, 4)]
...
rp = [
    ...
    1, 3, 7, 14, 6, 9, 11, 8, 12, 2, 10, 0, 4, 13, 8, 6, 4, 1, 3, 11, 15, 0, 5, 12, 2, 13, 9, 7, 10, 14
]
s = [
...
sp = [
    ...
    7, 15, 11, 8, 6, 6, 14, 12, 13, 5, 14, 13, 13, 7, 5, 15, 5, 8, 11, 14, 14, 6, 14, 6, 9, 12, 9, 12, 5, 15, 8
]
